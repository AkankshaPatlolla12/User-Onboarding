  ...
  return (
    <div className="emp-on-boarding-form">
        ...
        <div>
            ...
            <ul id="progressbar">
                <li className={formData.step > 0 ? 'active' : ''}></li>
                <li className={formData.step > 1 ? 'active' : ''}></li>
                <li className={formData.step > 2 ? 'active' : ''}></li>
                <li className={formData.step > 3 ? 'active' : ''}></li>
            </ul>
            {
                formData.step === 1 && (
                    <div>
                        ...
                        <form>
                            <div className="mb-3">
                                <label for="workspaceName" className="form-label">Full Name</label>
                                <input type="text" className="form-control" onChange={handleChange} name="fullName" id="workspaceName" placeholder="Eden"/>
                            </div>
                            <div className="mb-3">
                                <label for="workspaceName" className="form-label">Display Name</label>
...

            {
                formData.step === 2 && (
                    <div>
                        ...
                        <form>
                            <div className="mb-3">
                                <label for="workspaceName" className="form-label">Workspace Name</label>
                                <input type="text" className="form-control" onChange={handleChange} name="workspaceName" id="workspaceName" placeholder="Eden"/>
                            </div>
                            <label for="basic-url">Worspace URL<span className="sub-label">(Optional)</span></label>
